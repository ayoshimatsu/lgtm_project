...
# FULL PATH. Rewrite path depending on your environment
FONT_NAME = "/home/ayoshimatsu/pythonProject/lgtm_project/Fonts/FontsFree-Net-arial-bold.ttf"
FONT_COLOR_WHITE = (255, 255, 255, 0)
FONT_COLOR_BLACK = (0, 0, 0, 0)
OUTPUT_NAME = "outputs/output.png"
OUTPUT_FORMAT = "PNG"
...
def save_with_message(fp, message):
    ...
    for font_size in range(FONT_MAX_SIZE, FONT_MIN_SIZE, -1):
        ...
        if w > 0 and h > 0:
            ...
            draw.text(position, message, fill=FONT_COLOR_BLACK, font=font)
            break
